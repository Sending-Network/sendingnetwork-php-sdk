 ...
 *  NOTE: This does not verify the room with the Server.
 *
 * @package SdnSdk
 */
class Room {
    ...
    protected array $stateListeners = [];
    protected array $ephemeralListeners = [];
    protected array $events = [];
    protected int $eventHistoryLimit = 20;
    protected string $name;
    protected string $canonicalAlias;
    protected array $aliases = [];
    protected string $topic;
    protected bool $inviteOnly = false;
    protected string $guestAccess;
    public $prevBatch;
    protected array $_members = [];
    protected array $membersDisplaynames = [
        // $userId: $displayname,
    ];
     ...
     */
    public function __construct(SDNClient $client, string $roomId) {
     ...
     * @param string $name The filename of the image.
     * @param array|null $fileinfo Extra information about the image.
     * @return array|string
     * @throws SDNException
     ...
     * @param array|null $videoinfo Extra information about the video.
     * @return array|string
     * @throws SDNException
     * @throws SDNHttpLibException
     * @throws SDNRequestException
     ...
     * @param string $url The mxc url of the video.
     * @param string $name The filename of the video.
     * @param array|null $audioinfo Extra information about the video.
     * @return array|string
     * @throws SDNException
     * @throws SDNHttpLibException
     * @throws SDNRequestException
     ...
     * @throws Exceptions\SDNException
     */
    public function setRoomName(string $name): bool
    {
        try {
    ...
    public function getJoinedMembers() {
        $response = $this->api()->getJoinedMembers($this->roomId);
     ...
     * @throws Exceptions\SDNException
     */
    public function setGuestAccess(bool $allowGuest): bool
    {
        ...
        if ($clevel >= Cache::SOME) {
            switch ($etype) {
                ...
                case 'm.room.encryption':
                    ...
                    break;
                case 'm.room.member':
                    // tracking room members can be large
                    if ($clevel == Cache::ALL) {
    ...
    protected function api(): HttpApi {
